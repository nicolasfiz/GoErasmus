...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`idUsuario`,`facultad_idfacultad`),
...
INSERT INTO `usuario` VALUES (1,'Nico','nicolasfiz@outlook.com',NULL,NULL,'Admin',1),(2,'Nico2','nicolasfiz@topdigital.com',NULL,NULL,NULL,2);
