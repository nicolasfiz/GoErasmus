...
const getFiles = async (req, res) => {
    try {
        ...
        let query = await connection.query(`SELECT ar.idArchivo, ar.nombreArchivo, ar.titulo, ar.descripcion, ar.urlArchivo as url,
                                            DATE_FORMAT(ar.fecha, "%d/%m/%Y %r") as fechaSubida, u.nombreUsuario,
                                            asi.nombre as nombreAsignatura, v.numeroMeGusta as mg, v.numeroNoMeGusta as nmg FROM Archivo ar
